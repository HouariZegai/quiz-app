package com.houarizegai.javaquiz.java.controllers;

import com.houarizegai.javaquiz.java.dao.db.QuestionDao;
import com.houarizegai.javaquiz.java.dao.vo.QuestionVo;
import com.houarizegai.javaquiz.java.main.Launch;
...
public class JavaQuizController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            AnchorPane aboutPane = FXMLLoader.load(getClass().getResource("/com/houarizegai/javaquiz/resources/views/About.fxml"));
